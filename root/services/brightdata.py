...
class BrightDataService:
    def __init__(self, max_retries=5, base_delay=2, max_delay=10):
        load_dotenv()
        self.username = os.environ.get('BRIGHTDATA_USERNAME')
        self.password = os.environ.get('BRIGHTDATA_PASSWORD')
        self.port = int(os.environ.get('BRIGHTDATA_PORT', 33335))
        self.cert_path = os.environ.get('BRIGHTDATA_CERT_PATH')
